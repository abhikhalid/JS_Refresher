...
// ✈️✈️ Primitives vs. Objects in Practice
...
const marriedJessica = jessica; // we are just actually copying the reference
...
// Object.assing() only copies at the first level.
...
// And so, when we change the array in one of them, it's also gonna be changed in the other one. Now, a deep clone is what we would need here, but it is not easy to achieve, we do deep clone using an external library like Lo-Dash
